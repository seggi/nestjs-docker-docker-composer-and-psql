...
export class commingleInit1640537167627 implements MigrationInterface {
    name = 'commingleInit1640537167627'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "User" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "first_name" character varying NOT NULL, "last_name" character varying NOT NULL, "gender" character varying(10) NOT NULL, "birthDate" character varying(11) NOT NULL, "email" character varying NOT NULL, "phone" character varying(50), "isClient" boolean NOT NULL DEFAULT false, "isServiceOffer" boolean NOT NULL DEFAULT false, "username" character varying NOT NULL, "password" character varying NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "conformed_on" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updateDateTime" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "createDateTime" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleteDateTime" TIMESTAMP WITH TIME ZONE DEFAULT now(), "languageId" integer, "countryId" integer, "cityId" integer, "stateId" integer, CONSTRAINT "UQ_4a257d2c9837248d70640b3e36e" UNIQUE ("email"), CONSTRAINT "PK_9862f679340fb2388436a5ab3e4" PRIMARY KEY ("id"))`);
